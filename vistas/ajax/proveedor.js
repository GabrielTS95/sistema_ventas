...
function mostrarform(flag) {
    ...
    if (flag)  //si el flag viene true(verdadero)
    {
        ...
        $("#box-title").text("Nuevo Proveedor");
...
function listar() {
    $tabla = $('#tbllistado').dataTable({
        ...
        "ajax": {
            url: '../controladores/persona.php?op=listarp', //mediante ajax vamos a obtener valores de la url que hemos descrito
        ...
        "order": [[0, "asc"]] //odenar kos datos (idcategoria(0) de manera desenciente, 1 2 3)
    }).DataTable();
}
/* ############################################################################################################################### */
...
function guardaryeditar(e) {
    ...
    $.ajax({
        ...
        success: function (datos) {
            //datos es loque me muestra de mi pwersona.php
...
function mostrar(idpersona) {
    ...
    $.post("../controladores/persona.php?op=mostrar", {idpersona: idpersona }, function (data) {
        ...
        $("#box-title").text("Editar Proveedor");
...
//funcion eliminar
//Al final no vamos a eliminar ningun registro de la tabla, lo que vamos hacer es que los registros que no vamos a utilizar lo vamos a eliminar
