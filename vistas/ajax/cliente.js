...
function listar() {
    $tabla = $('#tbllistado').dataTable({
        ...
        "ajax": {
            url: '../controladores/persona.php?op=listarc', //mediante ajax vamos a obtener valores de la url que hemos descrito
