...
function mostrarform(flag)
{
    ...
    if(flag)  //si el flag viene true(verdadero)
    {
        ...
        $("#box-title").text("Nueva Categoría");
...
function listar()
{
        ...
        "ajax": {
                    url     :   '../controladores/categoria.php?op=listar', //mediante ajax vamos a obtener valores de la url que hemos descrito
...
$.post("../controladores/categoria.php?op=mostrar",{idcategoria : idcategoria},function(data)
    {
        ...
        $("#box-title").text("Editar Categoría");
